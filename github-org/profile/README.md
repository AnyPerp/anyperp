...
![token](https://img.shields.io/badge/%24PERP-live%20mainnet-2d6a4f?style=flat-square)

</div>

---

## $PERP community token
...
| **Page** | [anyperp.fun/#token](https://anyperp.fun/#token) |

Always verify the official CA before buying or adding liquidity.
